...
def convert(lhefile="pwgevents.lhe", treename="truth", run=10000, **kw):
...
if __name__ == "__main__": 
    ...
    if len(theargv)==1:
        ...
        print("     ./convert.py lhe-file tree-name run-number --> in addition, provide the run-number for outputing tree")
        print("")
        ...
        if len(theargv)==4: 
            convert(lhefile=theargv[1], treename=theargv[2], run=int(theargv[3]))
