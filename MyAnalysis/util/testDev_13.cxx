...
int main( int argc, char* argv[] ) {
   ...
   if(argc>=4) { 
     ...
     //SH::scanDir( sh, list, "DAOD_HIGG2D1.06998357._000007.pool.root.1" );
     SH::scanDir( sh, list, "DAOD_HIGG2D1.06998357._000007.pool.root.1" ); //ZZllvv_MC15b sample
     //SH::scanDir( sh, list, "DAOD_HIGG2D1.06607565._000001.pool.root.1" ); //ZH_inv MC15a sample
     //SH::scanDir( sh, list, "DAOD_HIGG2D1.07387959._000001.pool.root.1" ); //ZH_inv MC15b sample
     //SH::scanDir( sh, list, "DAOD_HIGG2D1.06645458._000001.pool.root.1" ); //Graviton_1600 sample
